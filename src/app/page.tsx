export default function Home() {
  return (
    <main className="flex flex-col gap-2 max-w-[600px] px-10 py-10 leading-relaxed text-base">
      <h1 className="text-lg font-bold">Aiden Bai</h1>

      <p>
        right now, i'm building{' '}
        <a href="https://ami.dev" className="underline decoration-stone-500 underline-offset-[2.5px] hover:decoration-stone-400">
          Ami
        </a>{' '}
        and{' '}
        <a
      ...
      <p>
        i care a lot about speed. in order to allow anyone to access great technology, you need to make it fast. in fact, most of my work (old and new) surrounds this.
      </p>
      ...
      <p>
        ...
        , or at{' '}
        <a href="mailto:aiden@million.dev" className="underline decoration-stone-500 underline-offset-[2.5px] hover:decoration-stone-400 underline-offset-[2.5px]">
          aiden@million.dev
        </a>
        !
      </p>
