...
const polaroids: {
  ...
  { src: capybara, alt: 'capybara', rotation: -14, offsetX: 0, offsetY: 6 },
  { src: isabelle, alt: 'isabelle', rotation: 7, offsetX: 55, offsetY: -8 },
  { src: japanPalace, alt: 'japan palace', rotation: -5, offsetX: 105, offsetY: 4 },
  { src: japanTrain, alt: 'japan train', rotation: 11, offsetX: 160, offsetY: -6 },
  { src: japanTunnel, alt: 'japan tunnel', rotation: -9, offsetX: 215, offsetY: 10 },
  { src: lowercase, alt: 'lowercase', rotation: 6, offsetX: 265, offsetY: -4 },
  { src: pranav, alt: 'pranav', rotation: -12, offsetX: 320, offsetY: 8 },
  { src: yosemite, alt: 'yosemite', rotation: 4, offsetX: 370, offsetY: -2 },
];
  ...
  return (
    <Tooltip.Provider delay={0}>
      <div className="w-full my-4">
        <div className="relative h-52 w-full pt-6">
            ...
            <Tooltip.Root key={index}>
              ...
              <Tooltip.Portal>
                <Tooltip.Positioner sideOffset={8}>
                  <Tooltip.Popup className="bg-stone-800 text-white text-sm px-2 py-1 rounded shadow-lg">
                    {polaroid.alt}
                  </Tooltip.Popup>
                </Tooltip.Positioner>
              </Tooltip.Portal>
